...
namespace App\Http\Controllers; // Defining the namespace for the controllers in the App\Http directory
...
class TaskManagerController extends Controller
{
    ...
    {
        // Check if the user is not authenticated. If so, return a JSON response with an 'Unauthenticated' error message and a 401 status code.
        if (!auth()->check()) {
        ...
        $data = $request->only(['title', 'description', 'status']); // Extract the 'title', 'description', and 'status' fields from the request data.

        return $this->successResponse($this->taskManagerService->createTask($data), Response::HTTP_CREATED); // Calling the 'createTask' method of the 'TaskManagerService' class to create a new task.
    }
    ...
    public function seeTasks()
    {
        ...
        return $this->successResponse($this->taskManagerService->getTaskList()); // Calling the 'getTaskList' method of the 'TaskManagerService' class to get the list of tasks.
    ...
    public function editTask(Request $request, $id)
    {
        ...
        return $this->successResponse($this->taskManagerService->updateTask($data, $id), Response::HTTP_CREATED); // Calling the 'updateTask' method of the 'TaskManagerService' class and passing the data and id
    }
    ...
    public function deleteTask($id)
    {
        ...
        return $this->successResponse($this->taskManagerService->deleteTask($id)); // Calling the 'deleteTask' method of the 'TaskManagerService' and passing the id
    }
}
