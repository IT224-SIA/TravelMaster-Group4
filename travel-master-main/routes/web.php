...
$router->get('/api/covid19/{country}', 'COVID19TrackingController@getCountryData'); // for getting country data about COVID19

# Task Manager
$router->get('/api/taskmanager', 'TaskManagerController@seeTasks'); // for viewing all tasks
